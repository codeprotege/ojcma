...
st.markdown(
    ...
    .hero-figure{position:relative;isolation:isolate;min-height:420px;border-bottom:1px solid var(--line);display:flex;align-items:flex-end;padding:clamp(1.5rem,4vw,3.75rem);background-color:#172d37;background-size:cover;background-position:center;overflow:hidden;}
    .hero-figure::before{content:'';position:absolute;inset:0;background:rgba(13,29,38,.64);z-index:-1;}
    .hero-content{position:relative;z-index:1;}
    .hero-figure h1{color:#f7f4ea !important;margin:0 !important;}
    .hero-figure .rail-kicker{color:#ff6e3b;}
...
st.markdown(
    f"<div class='hero-figure' style=\"background-image:url('{hero_image}')\"><div class='hero-content'>"
    "<div class='rail-kicker'>MEMBER PULSE / OCEAN JUNIOR CHAMBER</div>"
    "<h1>會員想成長，<br>也想連結。</h1></div></div>",
    unsafe_allow_html=True,
)
